...
Use like a standard shareable eslint config. Just add `extends: '@bramsey/eslint-config'`
(or one of the other usages below) to your eslint configuration.

### JavaScript Configuration Usage

Use the below syntax to use `@bramsey/eslint-config` in a JavaScript eslint
